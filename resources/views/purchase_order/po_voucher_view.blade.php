    ...
    <div class="voucher">
        ...
        <div class="header">
            ...
            <div class="d-flex justify-content-between">
                ...
                <h3 class="mt-0 mb-0 text-center" style="padding: 10px;text-decoration: underline"><strong>Cash
                        Voucher</strong></h3>
                <div class="mt-4">
                    {{-- <p><strong>PO No:</strong><span class="underline-dashed">&nbsp;&nbsp;&nbsp;{{ $make_payment->invoice && $make_payment->invoice->GetPrefix ? $make_payment->invoice->GetPrefix->invoice_no : '' }}-{{ $make_payment-> ? $make_payment->invoice->invoice_no : '' ?? $invoice->quote_no }}&nbsp;&nbsp;&nbsp;</span>
                    </p> --}}
                    <p><strong>Voucher No:</strong><span
                            class="underline-dashed">&nbsp;&nbsp;&nbsp;{{ $make_payment->po_no ?? $po->quote_no }}&nbsp;&nbsp;&nbsp;</span>
                    </p>
        ...
        <div class="content text-center">
            <p><strong>Received From:</strong><span
                    class="underline-dashed">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $po->supplier_name }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
            </p>
        </div>
        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    ...
                    <td>{{ $make_payment->amount }} {{ $po->currency_method }}</td>
                    <td>{{ $make_payment->amount }} {{ $po->currency_method }}</td>
                </tr>
                <tr>
                    <td colspan="2"><strong>Payment by</strong> -
                    </td>
                    {{-- <td class="text-center adjustment"><strong>Cash/Cheque</strong></td> --}}
                    <td><strong>{{ $make_payment->amount }} {{ $po->currency_method }}</strong></td>
                    <td><strong>{{ $make_payment->amount }} {{ $po->currency_method }}</strong></td>
                </tr>
            </tbody>
        </table>
