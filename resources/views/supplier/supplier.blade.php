         ...
         <div class="content-wrapper">
             ...
             <section class="content">
                 ...
                 <div class="ml-2 container-fluid">
                     ...
                     @if (in_array('Doctor Register', $userPermissions) || auth()->user()->is_admin == '1')
                         <div class="row">
                                     ...
                                     <tbody>
                                         ...
                                         @foreach ($suppliers as $supplier)
                                             <tr>
                                                 ...
                                                 <td>{{ $supplier->name }}</td>
                                                 <td>{{ $supplier->phno }}</td>
                                                 <td>{{ $supplier->sale_commission ?? 'N/A' }}</td>
                                                 ...
                                                 <td>
                                                     <div class="row">
                                                         @if (in_array('Doctor Edit', $userPermissions) || auth()->user()->is_admin == '1')
                                                             <a href="{{ url('doctors_edit', $supplier->id) }}"
                                                                 title="Supplier Edit" class="mx-2 btn btn-success"><i
                                                                     class="fa-solid fa-pen-to-square"></i></a>
                                                         @endif
                                                         @if (in_array('Doctor Delete', $userPermissions) || auth()->user()->is_admin == '1')
                                                             <a href="{{ url('doctors_delete', $supplier->id) }}"
                                                                 title="Supplier Delete"
                                                                 class="mx-2 btn btn-danger"><i
