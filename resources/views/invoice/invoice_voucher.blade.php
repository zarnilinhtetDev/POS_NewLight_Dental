            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="mt-4">
                    <p><strong>Invoice No:</strong><span
                            class="underline-dashed">&nbsp;&nbsp;&nbsp;{{ $make_payment->invoice && $make_payment->invoice->GetPrefix ? $make_payment->invoice->GetPrefix->invoice_no : '' }}-{{ $make_payment->invoice ? $make_payment->invoice->invoice_no : '' ?? $invoice->quote_no }}&nbsp;&nbsp;&nbsp;</span>
                    </p>
