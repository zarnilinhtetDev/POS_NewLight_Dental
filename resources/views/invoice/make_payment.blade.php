                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ $make_payments->invoice_no ?? '' }}" name="invoice_no" readonly>
            ...
            function fetchInvoiceUpdates() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        // console.log(data);
                        const invoiceNoInput = $("#invoice_no");
                        const saveInvoiceNoInput = $("#save_invoice_no");
                        console.log(data.invoice_no_with_prefix);
                        console.log(data.invoice_no);


                        if (data.invoice_no_with_prefix && invoiceNoInput.val() !== data
                            .invoice_no_with_prefix) {
                            invoiceNoInput.val(data.invoice_no_with_prefix);
                        }
                        if (data.invoice_no && saveInvoiceNoInput.value !== data.invoice_no) {
                            saveInvoiceNoInput.val(data.invoice_no);
                        }
                        console.log(saveInvoiceNoInput.val());
                    },
                    error: function(xhr, status, error) {
                        console.error("Failed to fetch invoice updates:", error);
                    }
