                                                        ...
                                                        <select name="doctor_id" id="doctor_id" class="form-control"
                                                            ...
                                                            @foreach ($doctors as $doctor)
                                                                <option value="{{ $doctor->id }}"
                                                                    {{ $doctor->id == $invoice->doctor_id ? 'selected' : '' }}>
                                                                    {{ $doctor->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <tbody id="showitem123">
                                                        <tr>
                                                            ...
                                                            <td><input type="text" class="form-control unit"
                                                                    name="category[]" value="{{ $sell->category }}"
                                                                    id="category-0">
                                                            ...
                                                            <td style="display: none;"><input type="hidden"
                                                                    ...
                                                                    name="sale_price[]" id="sale_price-0"
                                                                    autocomplete="off"
            ...
            $(document).ready(function() {
                ...
                function calculateTotals() {
                    ...
                    $('#showitem123 tr').each(function(index, row) {
                        ...
                        let price = parseFloat($(row).find('input[name="buy_price[]"]').val()) || 0;



                        if (salePriceCategory === 'Lab') {
                            price = parseFloat($(row).find('input[name="buy_price[]"]').val()) || 0;
                        } else {
                            price = parseFloat($(row).find('input[name="buy_price[]"]').val()) || 0;
                        }
