                                            ...
                                            <div class="frmSearch col-sm-12">
                                                ...
                                                <div class="col-md-12 d-flex justify-content-end">
                                                    <div class="form-group col-3">
                                                        ...
                                                        <select name="doctor_id" id="doctor_id" class="form-control"
                                                            required>
                                                            <option disabled selected>Select Doctor
                                                            </option>
                                                ...
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label for="age"
                                                                style="font-weight:bolder">Age</label>
                    ...
                    if ($("#item_name-0").val() === "") {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                $("#sale_price-0").val(data['item']['buy_price']);
                                $("#category-0").val(data['item']['item_unit']);
                                $("#buy_price-0").val(data['item']['buy_price'] ?? data['item'][
                                    'service_buy_price'
                                ]);
                ...
                function addNewRow(item) {
                    ...
                    if (existingRow.length > 0) {
                        ...
                        let newRow = '<tr>' +
                            ...
                            '<td><input type="text" class="form-control unit " name="category[]" id="category-' +
                            count +
                            '" autocomplete ="off"  value="' + item['item_unit'] +
                            '" required> </td>' +

                            '<td><input type="text" class="form-control buy_price" name="buy_price[]" id="buy_price-' +
                            count + '" autocomplete="off" value="' + (item['buy_price'] ?? item['service_buy_price']) +
                            '"></td>' +
                            '<td style="display:none"><input type="text" class="form-control sale_price" name="sale_price[]" id="sale_price-' +
                            count + '" autocomplete="off" value="' + (item['sale_price'] ?? 0) +
                            '"></td>' +
