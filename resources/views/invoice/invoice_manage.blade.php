                            ...
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-6 justify-content-end">
                                        <a href="{{ url('invoice_edit_history') }}" class="btn btn-primary">Edit
                                            History</a>
                                    </div>
                                    <div class="col-6 justify-content-end d-flex">
                                        <a href="{{ url('invoice_daily_sales') }}" class="btn btn-primary">Daily
                                            Sale</a>
                                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ url('/invoice_receipt', $invoice->id) }}" class="btn btn-warning btn-sm"><i class="text-white fa-solid fa-print"></i></a>
